  ...
  return (
    <div className="flex flex-col  md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558fE] to-[#A9CFFF] max-w-6xl mx-3  md:mx-auto rounded-2xl overflow-hidden ">
      <div className="text-white">
        <h2 className="text-3xl font-medium">Do Yo Own a Luxury Car ?</h2>
        <p className="mt-2">
          Monetize your vehicule efforessly by listing it on CarRental.
        </p>
        <p className="max-w-130">
          We take car of insurance, driver verification and secure payaments ,
